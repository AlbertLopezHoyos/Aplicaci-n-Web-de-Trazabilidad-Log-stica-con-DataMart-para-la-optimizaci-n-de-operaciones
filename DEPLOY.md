...
6. En **MySQL Workbench** (conexión con host/puerto público de Railway):
   ...
   - Ejecuta `backend/database/scripts/03_dimension4_gestion_informacion.sql` (incidencias)
   - Ejecuta `backend/database/scripts/07_muestra_investigacion.sql` (origen de datos, bitácora ETL)
