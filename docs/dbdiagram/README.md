...
Scripts DBML alineados con la **metodología Scrum de la tesis** (secciones 3.1–3.5).

No incluyen fichas de observación, medición de investigación ni campos de muestra (`origen_dato`, `grupo_muestra`).
...
| Kimball | `sprint-06-datamart.dbml` | `dim_*`, `fact_*` | ETL, Power BI |
...
El diseño dimensional (`dim_*`, `fact_*`) va en **`sprint-06-datamart.dbml`** (Kimball), no en el diagrama del Sprint 5.
